...
This project defines the provider-neutral test entities and `IMusicDomainContainer` contract used by both EF6 and EF Core test implementations. It references the query abstraction contracts from [Grammophone.DataAccess](https://github.com/grammophone/Grammophone.DataAccess/tree/adaptQueryOperations), but does not reference any concrete ORM provider.
